...
import { Grid,GridItem, Input,Image, Text, Flex,Button } from '@chakra-ui/react'
...
const NftTransfer = (props) => {
    ...
    return (
    <Grid justify="space-evenly" w={1000} h={550} gap={10} mt={10} templateColumns="repeat(5,1fr)">
        ...
        <GridItem colSpan="3" bg="whiteAlpha.400" borderRadius="30">
            ...
            <Flex justify="space-evenly" >
                ...
                <Input placeholder='from' variant='outline' borderRadius="30" w="70%" onChange={e=>setToAddr(e.target.value)}/>
            </Flex>
            <Button onClick={()=>transferMyNft(ToAddr)}>
                선물 보내기
            </Button>
        </GridItem>
    </Grid>
