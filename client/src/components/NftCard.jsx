...
const NftCard = (props) => {
  ...
  return (
    ...
    <Box w={400} h={500} bgGradient="linear(to-br, whiteAlpha.200,#b42020)" >
          <Text textAlign="left" padding={5} fontWeight="bold" fontSize={18}> Nfts : {remainNft} / 60</Text>
          {image ?
            <>
              <Box >
          ...
          : 
            <>
              <Text fontSize={28} fontWeight="bold" mt={10}> Holder NFT <br/> Red</Text>
    ...
    <Box w={400} h={500} bgGradient="linear(to-br, whiteAlpha.200,#549254)" >
          <Text textAlign="left" padding={5} fontWeight="bold" fontSize={18}> Nfts : {remainNft} / 30</Text>
          {image ?
            <>
              <Box >
                <Image mt={6} w={300} h={300} src={image} borderRadius={30}/>
          ...
          : 
            <>
              <Text fontSize={28} fontWeight="bold" mt={10}> Holder NFT <br/> Green</Text>
              <Text fontSize={16} mt={4}>(홀더 인증용 NFT)</Text>
              <Flex justify="space-around" padding={10} mt={6}>
                <Box >
                  <Image display="inline" src={ethLogo} mr={10} boxSize="2rem" bg="whiteAlpha.100" borderRadius={50}/>
    ...
    <Box w={400} h={500} bgGradient="linear(to-br, whiteAlpha.200,#9b61ca)" >
          <Text textAlign="left" padding={5} fontWeight="bold" fontSize={18}> Nfts : {remainNft} / 10</Text>
          {image ?
            <>
              <Box >
                <Image mt={6} w={300} h={300} src={image} borderRadius={30}/>
          ...
          : 
            <>
              <Text fontSize={28} fontWeight="bold" mt={10}> Holder NFT <br/> Purple</Text>
              <Text fontSize={16} mt={4}>(홀더 인증용 NFT)</Text>
              <Flex justify="space-around" padding={10} mt={6}>
                <Box >
                  <Image display="inline" src={ethLogo} mr={10} boxSize="2rem" bg="whiteAlpha.100" borderRadius={50}/>
