...
const Market_nft_auction_card = ({nft}) => {
    ...
    return (
                ...
                <Box w="300px" h="500" bg="blackAlpha.300" border="2px solid #287976b7" _hover={{boxShadow:'dark-lg' }}>
                      <Image src={nft.image} w="320" h="290" padding="5"/>
                      <Flex  justify="space-between" marginBottom="5vh" p="0px 25px">
                        <Box>
                         {nft.name}
                        </Box>
                        <Box  borderRadius="10" p="1" bg={nft.grade=="red"? "red.700" : nft.grade=="green" ? "green.700": "purple.700"} >{nft.grade}</Box> 
                      </Flex>
                      <Text align="left">
