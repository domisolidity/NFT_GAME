...
const ControlPanel = (props) => {
  ...
  const { account, gameTitle, score, resultBonus, getAttemptsMade, gameStart, hasMission } = props;
  ...
  const giveUp = async () => {
    ...
    await GameInterface.sendScore(account, gameTitle, score / 2, resultBonus);
    dispatch(giveUpGame());
  };
